...
- As of 2026-05-23 18:45 -0700, two user-reported "failed transcriptions" were actually `recordingFailed` / `recordingStop` attempts where the expected recorded `.m4a` was missing before transcription began. Audio finalization now waits for a non-empty output file and can recover the newest matching recording before teardown. Installed CDHash: `4eaf0a1bf28e9572271810bb19280a4f1ea018c9`.
- As of 2026-05-23 18:55 -0700, a `Disk Full` live failure was false storage exhaustion: disk readiness was healthy with about `42 GiB` free, but a missed-release recording ran about `30s` and AVFoundation failed before transcription. The default recording safety cap is now `25s`, and healthy-disk recorder failures no longer tell the user to free disk space. Installed CDHash: `71b6b2055cb0a995fc0d18ab48744b146dee6130`.
